...
class AddImageDialog : AppCompatDialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        super.onCreateDialog(savedInstanceState)
        val mBuilder = AlertDialog.Builder(activity)
        val mView = activity!!.layoutInflater.inflate(R.layout.dialog_add_image, null)
...
//        activity!!.setContentView(R.layout.dialog_add_image)
//
